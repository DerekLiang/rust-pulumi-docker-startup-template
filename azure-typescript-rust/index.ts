...
const resourceGroup = new resources.ResourceGroup("rust-docker-web",  {
...
const getStartedApp = new web.WebApp("getStartedApp", {
    ...
    siteConfig: {
        appSettings: [
            ...
            {
                name: "WEBSITES_PORT",
                value: "8000", // Our custom image exposes port 80. Adjust for your app as needed.
            },
        ],
        alwaysOn: true,
